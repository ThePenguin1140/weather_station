...
//   light            uint16  I2C ADC ch0       (raw counts; 0-255 PCF8591, 0-32767 ADS1115)
//   uv               uint16  I2C ADC ch1       (raw counts)
//   voltage          uint16  I2C ADC ch2       (solar battery, mV)
//   current          uint16  I2C ADC ch2-ch3   (load current, mA)
struct __attribute__((packed)) SensorData {
  ...
  uint16_t light;           // Light level, raw I2C ADC counts (ch0)
  uint16_t uv;              // UV level, raw I2C ADC counts (ch1)
  uint16_t voltage;         // Solar battery voltage in millivolts (ch2)
  uint16_t current;         // Load current in milliamps (ch2-ch3 / R8)
};
